...
def mock_retriever():
    ...
    docs = [Document(content=f"Document {i}", metadata={"id": i}) for i in range(10)]
...
class TestRetrievalAgentInitialization:
    ...
    def test_init_minimal(self, mock_retriever):
        ...
        agent = RetrievalAgent(jid="retrieval@localhost", password="password", retriever=mock_retriever)
    ...
    def test_behaviour_initialization(self, mock_retriever):
        ...
        agent = RetrievalAgent(jid="retrieval@localhost", password="password", retriever=mock_retriever, default_k=8)
...
class TestRetrievalAgentSetDefaultK:
    ...
    def test_set_default_k(self, mock_retriever):
        ...
        agent = RetrievalAgent(jid="retrieval@localhost", password="password", retriever=mock_retriever, default_k=4)
...
class TestRetrievalAgentEdgeCases:
    ...
    def test_none_callback(self, mock_retriever):
        ...
        agent = RetrievalAgent(
            jid="retrieval@localhost", password="password", retriever=mock_retriever, on_retrieval_complete=None
        )
