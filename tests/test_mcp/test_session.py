...
from spade_llm.mcp.session import MCPSession, create_mcp_session, create_stdio_params
...
class TestCreateStdioParams:
    ...
    def test_create_stdio_params_with_path_cwd(self):
        ...
        config = StdioServerConfig(name="path_server", command="python", cwd=Path("/home/user/project"))
    ...
    def test_create_stdio_params_preserves_types(self):
        ...
        config = StdioServerConfig(
            name="type_test", command="python", args=["arg1", "arg2"], env={"KEY": "value"}, read_timeout_seconds=10.5
        )
...
class TestCreateMCPSession:
    ...
    async def test_create_stdio_session_success(self):
        ...
        config = StdioServerConfig(name="test_server", command="python", args=["test.py"])
    ...
    async def test_create_stdio_session_with_timeout(self):
        ...
        config = StdioServerConfig(name="timeout_server", command="python", read_timeout_seconds=15.0)
    ...
    async def test_create_session_connection_error(self):
        ...
        config = StdioServerConfig(name="error_server", command="nonexistent_command")
    ...
    async def test_create_session_cleanup_on_error(self):
        ...
        config = StdioServerConfig(name="cleanup_test", command="python")
...
class TestMCPSession:
    ...
    def test_init(self):
        ...
        config = StdioServerConfig(name="test_server", command="python", cache_tools=True)
    ...
    async def test_get_tools_no_cache(self):
        ...
        config = StdioServerConfig(name="no_cache_server", command="python", cache_tools=False)
    ...
    async def test_get_tools_with_cache_first_call(self):
        ...
        config = StdioServerConfig(name="cache_server", command="python", cache_tools=True)
    ...
    async def test_get_tools_error_handling(self):
        ...
        config = StdioServerConfig(name="error_server", command="python")
    ...
    async def test_get_tools_session_initialize_error(self):
        ...
        config = StdioServerConfig(name="init_error_server", command="python")
    ...
    async def test_get_tools_list_tools_error(self):
        ...
        config = StdioServerConfig(name="list_error_server", command="python")
    ...
    async def test_call_tool_success(self):
        ...
        config = StdioServerConfig(name="tool_server", command="python")
    ...
    async def test_call_tool_execution_error(self):
        ...
        config = StdioServerConfig(name="exec_error_server", command="python")
...
class TestMCPSessionConcurrency:
    ...
    async def test_concurrent_get_tools_with_cache(self):
        ...
        config = StdioServerConfig(name="concurrent_server", command="python", cache_tools=True)
