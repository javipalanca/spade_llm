...
from spade_llm.mcp.adapters import MCPToolAdapter, SseMCPToolAdapter, StdioMCPToolAdapter
from spade_llm.mcp.config import SseServerConfig, StdioServerConfig
...
class TestMCPToolAdapterBase:
    ...
    def test_convert_schema_missing_properties(self):
        ...
        with patch("spade_llm.mcp.adapters.base.MCPSession"):
            ...
            expected_schema = {"type": "object", "required": ["param1"], "properties": {}}
    ...
    def test_convert_schema_missing_type(self):
        ...
        with patch("spade_llm.mcp.adapters.base.MCPSession"):
            ...
            expected_schema = {"type": "object", "properties": {"param": {"type": "string"}}}
            assert adapter.parameters == expected_schema
...
class TestMCPToolAdapterExecution:
    ...
    def test_process_result_multiple_content(self):
        ...
        with patch("spade_llm.mcp.adapters.base.MCPSession"):
            ...
            expected = [{"type": "text", "text": "First result"}, {"type": "text", "text": "Second result"}]
...
class TestStdioMCPToolAdapter:
    ...
    def test_init_success(self):
        ...
        config = StdioServerConfig(name="stdio_server", command="python", args=["server.py"])
    ...
    def test_init_wrong_config_type(self):
        ...
        wrong_config = SseServerConfig(name="sse_server", url="https://example.com")
    ...
    def test_init_with_complex_config(self):
        ...
        mock_tool.inputSchema = {
            "type": "object",
            "properties": {"input": {"type": "string"}, "options": {"type": "object"}},
            "required": ["input"],
        }
    ...
    async def test_execute_tool_integration(self):
        ...
        config = StdioServerConfig(name="integration_server", command="python")

        # Mock the execution result
        mock_content = Mock()
        mock_content.model_dump.return_value = {"type": "text", "text": "STDIO execution successful"}
...
class TestSseMCPToolAdapter:
    ...
    def test_init_wrong_config_type(self):
        ...
        wrong_config = StdioServerConfig(name="stdio_server", command="python")
    ...
    def test_init_with_complex_config(self):
        ...
        mock_tool.inputSchema = {
            "type": "object",
            "properties": {"query": {"type": "string"}, "filters": {"type": "array", "items": {"type": "string"}}},
        }

        config = SseServerConfig(
            name="complex_sse_server",
            url="https://api.complex.com/sse/events",
            headers={"Authorization": "Bearer token123", "Accept": "text/event-stream"},
            timeout=60.0,
    ...
    async def test_execute_tool_integration(self):
        ...
        config = SseServerConfig(name="sse_integration_server", url="https://sse.example.com/events")

        # Mock the execution result
        mock_content = Mock()
        mock_content.model_dump.return_value = {"type": "text", "text": "SSE execution successful"}
        ...
        with patch("spade_llm.mcp.adapters.base.MCPSession", return_value=mock_session):
            ...
            # Should call the underlying tool with correct parameters
            mock_session.call_tool.assert_called_once_with("sse_integration_tool", {"message": "test message"})
...
class TestMCPAdaptersEdgeCases:
    ...
    def test_adapter_with_very_long_names(self):
        ...
        config = StdioServerConfig(name=long_server_name, command="python")
    ...
    def test_adapter_with_special_characters_in_names(self):
        ...
        config = SseServerConfig(name=special_server_name, url="https://example.com")
    ...
    def test_adapter_with_complex_nested_schema(self):
        ...
        config = StdioServerConfig(name="nested_server", command="python")
