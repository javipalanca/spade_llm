...
class TestCharacterTextSplitter:
    ...
    def test_split_documents(self):
        ...
        documents = [
            Document(
                id="doc1", content="Paragraph one.\n\nParagraph two.\n\nParagraph three.", metadata={"source": "test1"}
            ),
            Document(id="doc2", content="Another document.\n\nWith more content.", metadata={"source": "test2"}),
        ]
    ...
    def test_split_text_with_separator_regex(self):
        ...
        splitter = CharacterTextSplitter(chunk_size=10, chunk_overlap=0, separator=r"\s+", is_separator_regex=True)
    ...
    def test_keep_separator_start(self):
        ...
        splitter = CharacterTextSplitter(chunk_size=10, chunk_overlap=0, separator="<SEP>", keep_separator="start")
    ...
    def test_keep_separator_end(self):
        ...
        splitter = CharacterTextSplitter(chunk_size=10, chunk_overlap=0, separator="<SEP>", keep_separator="end")
    ...
    def test_empty_separator_with_regex(self):
        ...
        splitter = CharacterTextSplitter(chunk_size=3, chunk_overlap=0, separator="", is_separator_regex=True)
    ...
    def test_empty_separator(self):
        ...
        splitter = CharacterTextSplitter(chunk_size=2, chunk_overlap=1, separator="")
...
class TestRecursiveCharacterTextSplitter:
    ...
    def test_initialization_custom_separators(self):
        ...
        custom_seps = ["\n\n", "\n", " "]
        splitter = RecursiveCharacterTextSplitter(chunk_size=100, chunk_overlap=20, separators=custom_seps)
...
Second paragraph also has many words that exceed the chunk size."""
        ...
        chunks = splitter.split_text(text)
        expected_chunks = [
            "First paragraph has many words",
            "here.",
            "Second paragraph also has",
            "has many words that exceed",
            "the chunk size.",
        ]
    ...
    def test_custom_separators_order(self):
        ...
        splitter = RecursiveCharacterTextSplitter(chunk_size=30, chunk_overlap=0, separators=["###", "##", "#", " "])
    ...
    def test_keep_separator_recursive(self):
        ...
        splitter = RecursiveCharacterTextSplitter(
            chunk_size=15, chunk_overlap=0, separators=["\n\n", "\n"], keep_separator=True
        )
    ...
    def test_keep_separator_with_multiple_separators(self):
        ...
        splitter = RecursiveCharacterTextSplitter(
            chunk_size=21, chunk_overlap=0, separators=["<SEP><SEP>", "<SEP>"], keep_separator="start"
        )
    ...
    def test_add_start_index_in_metadata(self):
        ...
        expected_contents = [
            "This is a text that will be",
            "be split into chunks. This is",
            "is a text that continues.",
        ]
    ...
    def test_no_start_index_when_disabled(self):
        ...
        splitter = RecursiveCharacterTextSplitter(chunk_size=30, chunk_overlap=5, add_start_index=False)
    ...
    def test_metadata_deep_copy(self):
        ...
        doc = Document(content="Long text here for splitting into chunks", metadata=original_metadata)
