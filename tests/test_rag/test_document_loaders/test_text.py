...
from spade_llm.rag.document_loaders.text import DirectoryLoader, TextLoader
...
class TestDirectoryLoader:
    ...
    def test_get_loader_for_file_parameter_passing(self):
        ...
        loader = DirectoryLoader("/path", encoding="utf-8", metadata={"base": "meta"}, loader_map={".mock": MockLoader})
