...
class TestLLMToolInitialization:
    ...
    def test_init_basic(self):
        ...
        tool = LLMTool(
            name="test_tool", description="A test tool", parameters={"type": "object", "properties": {}}, func=test_func
        )
    ...
    def test_init_with_complex_parameters(self):
        ...
        parameters = {
            ...
            "properties": {
                ...
                "number": {"type": "integer", "description": "Input number", "minimum": 0},
                "optional": {"type": "boolean", "description": "Optional flag", "default": False},
            },
            "required": ["text", "number"],
        }

        tool = LLMTool(name="complex_tool", description="A complex test tool", parameters=parameters, func=complex_func)
...
class TestLLMToolEdgeCases:
    ...
    def test_tool_with_empty_name(self):
        ...
        tool = LLMTool(
            name="", description="Empty name tool", parameters={"type": "object", "properties": {}}, func=test_func
        )
    ...
    def test_tool_with_none_description(self):
        ...
        tool = LLMTool(name="test", description=None, parameters={"type": "object", "properties": {}}, func=test_func)
    ...
    def test_tool_with_none_parameters(self):
        ...
        tool = LLMTool(name="test", description="Test tool", parameters=None, func=test_func)
