...
class Chroma(VectorStore):
    ...
    def _create_documents_from_results(
        self, ids: List[str], documents: List[str], metadatas: List[Any], distances: Optional[List[float]] = None
    ) -> List:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            raise ImportError("ChromaDB is required for Chroma. Install with: pip install chromadb")
    ...
    async def similarity_search_with_score(
        self, query: str, k: int = DEFAULT_K, **kwargs
    ...
    async def get_by_ids(self, ids: List[str]) -> List[Document]:
        ...
        results = await asyncio.to_thread(self._collection.get, ids=ids, include=["documents", "metadatas"])
    ...
    async def from_documents(
        ...
        **kwargs,
        ...
        """
        store = cls(collection_name=collection_name, embedding_fn=embedding_fn, **kwargs)
    ...
    async def from_texts(
        ...
        **kwargs,
        ...
        documents = [Document(id=id_, content=text, metadata=meta) for id_, text, meta in zip(ids, texts, metadatas)]

        return await cls.from_documents(
            documents=documents, embedding_fn=embedding_fn, collection_name=collection_name, **kwargs
        )
